...
### 프로젝트 후기
<h4>강희명</h4>
- 팀 프로잭트 개발에 코딩 기술과 체력 시간 관리 밸런스가 매우 중요하다는 것을 배웠습니다. 본인 자신의 코딩 스피드와 해결 방안을 도출하는 스킬 상향에 대한 고민과 다른 코딩 작성자분들이 문제 방식을 해결해 나아가는 과정을 교류하고 참여한것이 큰 경험이 되었다고 생각합니다.
